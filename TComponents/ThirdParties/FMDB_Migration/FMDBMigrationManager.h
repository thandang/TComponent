...
+ (instancetype) executeForDatabasePath:(NSString *)aPath withMigrations:(NSArray *)migrations;
...
+ (instancetype) executeForDatabasePath:(NSString *)aPath withMigrations:(NSArray *)migrations andMatchVersion:(NSInteger)aVersion;
